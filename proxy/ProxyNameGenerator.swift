...
class ProxyNameGenerator: NSObject {
    ...
    override init() {
        ...
        nouns = ["angel", "baby", "bacon", "bandit", "bear", "beast", "blade", "bunny", "cat", "champ", "champion", "crab", "crush", "dancer", "darling", "demon", "dog", "dork", "dove", "dragon", "drake", "fairy", "flirt", "flower", "fox", "frog", "genius", "ghost", "goat", "god", "hawk", "hero", "honey", "hunter", "icon", "kid", "king", "kisser", "kitty", "lion", "master", "model", "money", "monster", "moon", "ninja", "nova", "ocean", "panda", "penguin", "piggy", "pirate", "pizza", "player", "poet", "punk", "pup", "puppy", "rabbit", "rose", "savage", "shark", "sheep", "singer", "smile", "song", "soul", "squirt", "star", "sushi", "swan", "sword", "thief", "thug", "thunder", "tiger", "tuna", "villain", "waffle", "whale", "wolf", "zombie"]
    }
