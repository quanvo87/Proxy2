...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Fusuma-iOS10.0/Fusuma.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MobilePlayer-iOS10.0/MobilePlayer.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RAMReel-iOS10.0/RAMReel.framework"
fi
